...
# --- [1] التصميم العام والهيدر الثابت ---
# استخدمنا الهيدر الخاص بك ليكون موحداً وثابتاً في كل الموقع
COMMON_HEADER = '''
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .spacer { margin-top: 60px; } /* مساحة تحت الهيدر الثابت */
        ...
        /* تنسيقات صفحة الاستعلام المنحوتة */
        ...
        select, input { width: 100%; padding: 14px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; box-sizing: border-box; outline: none; }
...
# --- [3] مسار صفحة الاستعلام (النحت الاحترافي للفئات) ---
@app.route('/search')
def search():
    content = '''
            ...
            <div class="grid">
                ...
                <div class="input-group">
                    ...
                    <select>
                        ...
                        <optgroup label="الفئات الرقمية (أبوظبي/الشمالية)">
                            <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>17</option><option>50</option>
                        </optgroup>
                        <optgroup label="الفئات الحرفية (دبي/الشارقة)">
                        ...
                        <optgroup label="الفئات المزدوجة (دبي الجديدة)">
